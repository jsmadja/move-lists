games.push({
    ...
    cover: 'cover/fight-history-dynamite.jpg',
    characters: [
        {
            firstname: 'Ray',
            lastname: 'McDougal',
            face: 'http://valou.ludo.free.fr/NEO/Tarma/guide/karnov_ray.jpg',
            moves: [
                {name: 'Big Tornado', commands: ['qcf', '+', 'A', 'ou', 'B']},
        ...
        },
        {
            firstname: 'Liu',
            lastname: 'Yungmie',
            face: 'http://valou.ludo.free.fr/NEO/Tarma/guide/karnov_yungmie.jpg',
            moves: [
                {name: 'Aura Smash', commands: ['(saut)', 'qcf', '+', 'A', 'ou', 'B']},
                {name: 'Nerichagi', commands: ['f', 'db', 'df', '+', 'C', 'ou', 'D']},
                {name: 'Fire Binta', commands: ['A', 'C', 'ou', 'B', 'D', 'à répétition']}
            ]
        },
        {
            firstname: 'Zazie',
            lastname: 'Muhaba',
            face: 'http://valou.ludo.free.fr/NEO/Tarma/guide/karnov_zazie.jpg',
            moves: [
        ...
        },
        {
            firstname: 'Liu',
            lastname: 'Feiling',
            face: 'http://valou.ludo.free.fr/NEO/Tarma/guide/karnov_feilin.jpg',
            moves: [
        ...
        },
        {
            firstname: 'Makoto',
            lastname: 'Mizoguchi',
            face: 'http://valou.ludo.free.fr/NEO/Tarma/guide/karnov_mizoguchi.jpg',
            moves: [
                {name: 'Tiger Bazooka', commands: ['qcf', '+', 'A', 'ou', 'B']},
                {name: 'Special Tiger Bazooka', commands: ['qcf', '+', 'A', 'B', 'C', 'D']},
                {name: 'Mid-air Kick', commands: ['qcf', '+', 'C', 'ou', 'D', 'x5']},
                {name: 'Tiger Wave', commands: ['qcb', '+', 'A', 'ou', 'B']},
                {name: 'Sho Ten Sai', commands: ['qcb', '+', 'A', 'B', 'C', 'D']}
            ]
        },
        {
            firstname: 'Jean',
        ...
        },
        {
            firstname: 'Ryôko',
            lastname: 'Kanô',
            face: 'http://valou.ludo.free.fr/NEO/Tarma/guide/karnov_ryoko.jpg',
            moves: [
        ...
        },
        {
            firstname: 'Samchay',
            lastname: 'Tomyamgun',
            face: 'http://valou.ludo.free.fr/NEO/Tarma/guide/karnov_samchay.jpg',
            moves: [
                {name: 'Pap Sok Kau', commands: ['A', 'C', 'ou', 'B', 'D']},
                {name: 'Ti Kau Loi', commands: ['f', 'db', 'df', '+', 'C', 'ou', 'D']},
                {name: 'Ti Kau Koon', commands: ['qcf', 'C', 'ou', 'D']},
                {name: 'Mattron Dusalop', commands: ['qcf', 'A', 'ou', 'B']}
            ]
        },
        {
            firstname: 'Matlok',
        ...
        },
        {
            firstname: 'Lee',
            lastname: 'Diendô',
            face: 'http://valou.ludo.free.fr/NEO/Tarma/guide/karnov_lee.jpg',
            moves: [
                {name: 'Senkyu Tai', commands: ['qcf', '+', 'C', 'ou', 'D']},
                {name: 'Zesho Hoho (1)', commands: ['qcf', '+', 'A', 'ou', 'B']},
                {name: 'Super Zesho Hoho (2)', commands: ['qcf', 'b', '+', 'A', 'ou', 'B']},
                {name: 'Choshin Chu', commands: ['(1) ou (2)', '+', 'f', 'f', '+', 'A']},
                {name: 'Tetsuzan Kô', commands: ['(1) ou (2)', '+', 'f', 'f', '+', 'B']},
                {name: 'Moko Kuha Zan', commands: ['b', 'f', 'db', 'df', '+', 'A', 'B']}
            ]
        },
        {
            firstname: 'Marstorius',
            lastname: '',
        ...
        },
        {
            firstname: 'Jinborov',
            lastname: 'Karnoski',
            face: 'http://valou.ludo.free.fr/NEO/Tarma/guide/karnov_karnov.jpg',
            moves: [
